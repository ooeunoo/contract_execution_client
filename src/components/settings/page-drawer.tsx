...
function PageItems() {
  return (
    <div className="grid grid-cols-1 gap-8 pb-10 xs:grid-cols-2 lg:grid-cols-3 3xl:grid-cols-4">
      {PageLinks.map((item, index) => (
        <div
          className="overflow-hidden rounded-lg bg-white text-gray-900 transition-all hover:-translate-y-1 dark:bg-gray-800 dark:text-white"
          key={index}
        >
...
export default function ViewPagesModal() {
  ...
  return (
    <Transition appear show={isPageDrawerOpen} as={Fragment}>
      <Dialog
        as="div"
