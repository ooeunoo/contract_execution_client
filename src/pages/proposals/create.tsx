...
const actionOptions = [
  ...
  {
    name: 'ChainManager Token',
    value: 'ChainManager_token',
  },
  {
    name: 'Reserve',
    value: 'reserve',
...
const ChainManagerTokenOptions = [
  {
    name: 'Approve',
    value: 'approve',
  },
...
function ChainManagerTokenAction({
  selectedOption,
  onChange,
}: {
  ...
  return (
    <>
      <Listbox
        ...
        options={ChainManagerTokenOptions}
...
function ActionFields() {
  ...
  let [ChainManagerTokenAction, setChainManagerTokenAction] = useState(
    ChainManagerTokenOptions[0]
  );
  return (
    <div className="">
      <div className="group mb-4 rounded-md bg-gray-100/90 p-5 pt-3 dark:bg-dark/60 xs:p-6 xs:pb-8">
        ...
        <>
          ...
          {actionType.value === 'ChainManager_token' && (
            <div className="rtl:xs:mlr6 rtl:sm:mlr12 mt-4 ltr:xs:ml-6 ltr:sm:ml-12">
              <ChainManagerTokenAction
                selectedOption={ChainManagerTokenAction}
                onChange={setChainManagerTokenAction}
              />
            </div>
          )}
            ...
            <div className="flex items-start gap-4 xs:gap-3 xl:gap-4">
              ...
              <div>
                ...
                <p className="leading-[1.8] text-gray-600 dark:text-gray-400">
                  ...
                  ChainManager tokens <br className="hidden xl:inline-block" />{' '}
                  delegated to you{' '}
                  <a
                    target="_blank"
